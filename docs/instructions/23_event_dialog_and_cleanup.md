...
1. `docs/instructions/audit_fixes.md` と `docs/instructions/step8_fix_instructions.md` を
...
```
docs/instructions/*.md（本書以外。§1-D-1 の 2 枚は移動のみ）  README.md
...
`docs/handoff/2026-09-05-04/04-result.md` に規約 §5 の様式で書く。
