...
ROLE: Executor
BRANCH: main
判断: docs/cycles/2026-09-04-03/03-instruction.md（案 1-B + 案 2-A 採用・実装方針は本書に従う）
```
...
`docs/cycles/2026-09-04-03/04-result.md` に規約 §5 の様式で書く。

```
指示書: docs/cycles/2026-09-04-03/18_boss_overlay_and_english_text.md
再試行: N / 2
