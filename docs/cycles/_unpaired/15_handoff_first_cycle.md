...
- [x] `docs/cycles/<今日の日付>-01/` を作り、`01-request.md` に人間から受けた要件を**逐語で**書く
...
```
指示書: docs/cycles/_unpaired/15_handoff_first_cycle.md
作成: docs/cycles/<日付>-01/01-request.md, 02-context.md
