...
ROLE: Executor
BRANCH: main
判断: docs/cycles/2026-09-05-01/03-instruction.md
...
`docs/cycles/2026-09-05-01/04-result.md` に規約 §5 の様式で書く。

```
指示書: docs/cycles/2026-09-05-01/20_gameover_ending_and_restart.md
再試行: N / 2
